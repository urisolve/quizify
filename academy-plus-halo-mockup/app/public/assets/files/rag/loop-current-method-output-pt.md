...
![Pontos de interligação](circuit-png/02-nodes.png)
...
|---|---|---|
| Fonte de corrente (CC) | $I_{1}$ | $13\~\mathrm{A}$ |
| Fonte de tensão (CC) | $V_{1}$ | $19\~\mathrm{V}$ |
| Resistência | $R_{1}$ | $355\~\mathrm{\Omega}$ |
| Resistência | $R_{2}$ | $540\~\mathrm{\Omega}$ |
| Resistência | $R_{3}$ | $795\~\mathrm{\Omega}$ |
...
>
> - Nós essenciais (N): node_a, node_b, node_c
> - Nós internos: -
...
> Verificação de consistência: o solver selecionou Mp = 2 e Ma = 1.
...
- Ma1 (id da malha=1): ramos [4, 5]
- Corrente de malha conhecida: $13\~\mathrm{A}$

#### Mp - Malhas principais (correntes fictícias desconhecidas)

- Mp1 (id da malha=2): ramos [1, 3] / a
- Sinais de percurso nos ramos: [1, -1]
- Corrente de malha obtida: $-7,468\~\mathrm{mA}$

- Mp2 (id da malha=3): ramos [1, 4, 2] / b
- Sinais de percurso nos ramos: [1, 1, -1]
- Corrente de malha obtida: $24,19\~\mathrm{mA}$
...
| Etapa | Equação |
|---|---|
| Forma simbólica | $$ 0 = R1,(I_{Mp1}+I_{Mp2})+R3,(I_{Mp1}) $$ |
| Substituição Ma | $$ 0 = R1,(I_{Mp1}+I_{Mp2})+R3,(I_{Mp1}) $$ |
| Valores numéricos | $$ 0 = 355,(I_{Mp1}+I_{Mp2})+795,(I_{Mp1}) $$ |
...
| Etapa | Equação |
|---|---|
| Forma simbólica | $$ V1=R1,(I_{Mp1}+I_{Mp2})+R2,(I_{Mp2}) $$ |
| Substituição Ma | $$ V1=R1,(I_{Mp1}+I_{Mp2})+R2,(I_{Mp2}) $$ |
| Valores numéricos | $$ 19=355,(I_{Mp1}+I_{Mp2})+540,(I_{Mp2}) $$ |
